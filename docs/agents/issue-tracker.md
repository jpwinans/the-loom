...
Issues and PRDs for this repo live as GitHub issues on `jpwinans/the-loom`. Use the `gh` CLI for all operations.

## Prior tracker (Jira)

Until 2026-08-09 the canonical tracker was **Jira Cloud**, project `TL` at
`https://hiereus-studios.atlassian.net`. Existing `TL-…` references in commit messages,
